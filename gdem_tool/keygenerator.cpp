	...
	: QMainWindow(parent, flags)
{
	...
	ui.lineEditModelNumber->setText(FormatKey(GetPhysicalDrive0ModelNumber(), 16));

	ui.lineEditKey->setInputMask("HHHH-HHHH-HHHH-HHHH");
	ui.lineEditKey->setText("0000000000000000");
	connect(ui.pushButtonKeyGen,SIGNAL(clicked()),this,SLOT(keyGen()));
}
...
void KeyGenerator::keyGen()
{
	QString modelnumber=ui.lineEditModelNumber->text();

	modelnumber.replace("-","");

	ui.lineEditKey->setText(FormatKey(GetKey(modelnumber), 16));
}
