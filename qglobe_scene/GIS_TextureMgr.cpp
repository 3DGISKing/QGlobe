...
#define QGlobe_GIS_TEXTURE_SAME_THREAD

CGIS_TextureMgr* g_pGisTextureMgr = NULL;
CGIS_TextureMgr * qglobe_GetGISTextureMgr(){return g_pGisTextureMgr;}
...
void CGIS_TextureMgr::DelTexture(unsigned long TextureID)
{
	...
	g_TextureListMutex.lock();
#ifdef QGlobe_GIS_TEXTURE_SAME_THREAD
...
{		
#ifndef QGlobe_GIS_TEXTURE_SAME_THREAD
