...
}QGLOBE_RENDER_GEO_PARAM;

#define QGlobe_GIS_MAX_ANGLE	80
...
extern QGlobe_MESH_TILE_ARR g_qglobe_MeshTileArr;
extern void qglobe_GetPyramidDivisionTiles(QGlobe_MESH_TILE_ARR *pArr);
