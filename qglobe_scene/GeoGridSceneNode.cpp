...
extern int	qglobe_CallBackGetGridVtx(void* pUserData, void *param1, void *param2, void *param3);
...
namespace geo
{
	namespace scene
	{
		...
		{			
			...
			qglobe_CallBackGetGridVtx(NULL, &m_gridArray, &m_gridTropicArray, NULL);
