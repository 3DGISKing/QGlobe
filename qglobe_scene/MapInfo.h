...
public:
	...
	bool       isContained(CQGlobe_Rect2D rec)   {return m_MapRect.isContained(rec); }
	bool       isIntersected(CQGlobe_Rect2D rec) {return m_MapRect.isRectCollided(rec); }
...
private:
	...
	CQGlobe_Rect2D m_MapRect;   //express the bounding rect of map
