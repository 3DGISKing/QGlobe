...
/********************************************************** 
					Constatns
**********************************************************/
#define TREEITEM_NAME_STR_MAX_LEN	(PMD_STR_MAX_SIZE)	// PMD_STR_MAX_SIZE is defined in "qglobeclientbase.h" file
...
public:
	...
	void SetSubType(const E_QGlobe_SUBDATA_TYPE subtype);
	E_QGlobe_SUBDATA_TYPE GetSubType();	
...
private:
	...
	E_QGlobe_SUBDATA_TYPE	m_subtype;
	QString				m_name;
	QString				m_desc;
	QString				m_styleurl;
