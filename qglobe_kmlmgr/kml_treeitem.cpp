...
********************************************************/
void KmlTreeItem::SetSubType(const E_QGlobe_SUBDATA_TYPE subtype)
{
	m_subtype = subtype;
}
...
********************************************************/
E_QGlobe_SUBDATA_TYPE KmlTreeItem::GetSubType()
{
	return m_subtype;
}
...
int KmlTreeItem::ConvertFromTreeItemData(PLACEMARK_DATA* tdata)
{
	...
	// SubType
	m_subtype = (E_QGlobe_SUBDATA_TYPE)tdata->type;
...
/*		new_style->labelstyle->colormode = pNode->;
		...
		CQGlobe_Location3D	pt = pNode->GetPt();
