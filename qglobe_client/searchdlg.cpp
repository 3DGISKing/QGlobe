...
void SearchDlg::cmbSearchStyle_change(int style)
{
	...
	case 1:
		...
		m_pCommand = (CQGlobe_MeasureAreaCmd*)pCmdMgr->CreateCmd(eQGlobe_CMD_MEASUREAREA, this);
		break;
	}
}
...
static void MakeViewRange(PLACEMARK_DATA *pmd)
{
	...
	if(pmd->view_range == 0)
	{
		switch(pmd->type)
		{
		case E_QGlobe_SUBDATA_TYPE_NAME_COUNTRY:
			dist = 1500000;
			break;
		case E_QGlobe_SUBDATA_TYPE_NAME_POPULAR:
			dist = 15000;
			break;
		case E_QGlobe_SUBDATA_TYPE_NAME_FIRSTADMIN:
			dist = 150000;
			break;
		case E_QGlobe_SUBDATA_TYPE_NAME_SECONDADMIN:
			dist = 2000;
			break;
		case E_QGlobe_SUBDATA_TYPE_NAME_THIRDADMIN:
			dist = 1000;
			break;
		case E_QGlobe_SUBDATA_TYPE_NAME_SEA:
			dist = 15000;
			break;
		case E_QGlobe_SUBDATA_TYPE_NAME_MOUNTAIN:
			dist = 1000;
			break;
		case E_QGlobe_SUBDATA_TYPE_NAME_RIVER:
			dist = 5000;
			break;
		default:
			dist=1000;
...
loopBreak:
	...
	//<span style=" font-size:8pt; color:#ff0000;">1</span>&nbsp;<a href="http://pic.com/maps?q=��&start=17^itemkey=3"><span style=" text-decoration: underline; color:#0000ff;">2</span></a>&nbsp;
