...

{
	...
	// create command
	CQGlobe_CommandMgr* pCmdMgr = g_app->GetRenderProxy()->GetRenderSrv()->GetCommandMgr();
	m_pCommand = (CQGlobe_ObjectAddCmd*)pCmdMgr->CreateCmd(eQGlobe_CMD_OBJECT_ADD, this);
...
{
	if(m_pCommand->_toolState==CQGlobe_ObjectAddCmd::Select)
	{
...
{
	ui->longitudeDoubleSpinBox->setValue(m_pCommand->_GeoInfo.Longitude*qglobe_RADTODEG);
	ui->latitudeDoubleSpinBox->setValue(m_pCommand->_GeoInfo.Latitude*qglobe_RADTODEG);
...
{
	this->m_pCommand->_GeoInfo.Longitude=newval*qglobe_DEGTORAD;
	if(this->m_pCommand->_sampleMesh)
		this->m_pCommand->SetSampleMeshLocation();
	else if(this->m_pCommand->_selectedGeoMesh)
		this->m_pCommand->SetSelectedGeoMeshLocation();
...
{
	this->m_pCommand->_GeoInfo.Latitude=newval*qglobe_DEGTORAD;
	if(this->m_pCommand->_sampleMesh)
		this->m_pCommand->SetSampleMeshLocation();
	else if(this->m_pCommand->_selectedGeoMesh)
		this->m_pCommand->SetSelectedGeoMeshLocation();
...
{
	m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::SetAltitude);
}

void ObjectAddDlg::SetDirectionState()
{
	m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::SetDirection);
}

void ObjectAddDlg::SetPositionState()
{
	m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::SetPosition);
}

void ObjectAddDlg::SetScalingAllAxis()
{
	m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::ScaleAllAxis);
}

void ObjectAddDlg::SetScalingXAxis()
{
    m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::ScaleXAxis);
}

void ObjectAddDlg::SetScalingYAxis()
{
     m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::ScaleYAxis);
}

void ObjectAddDlg::SetRotateXAxis()
{
	m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::RoateXAxis);
}

void ObjectAddDlg::SetRotateYAxis()
{
	m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::RoateYAxis);
}

void ObjectAddDlg::SetScalingZAxis()
{
	 m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::ScaleZAxis);
}


void ObjectAddDlg::SetScalingXYAxis()
{
	m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::ScaleXYAxis);
}

void ObjectAddDlg::SetBackGroundMove()
{
	m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::BackgroundMove);
}
...
{
	m_pCommand->SetToolState(CQGlobe_ObjectAddCmd::Select);
	if(m_pCommand->_sampleMesh)
...
void ObjectAddDlg::Save()
{
	if(m_pCommand->_sampleMesh)
	{
		...
		if(m_pCommand->_objectType==CQGlobe_ObjectAddCmd::Building)
...
{
	m_pCommand->SetObjectType((CQGlobe_ObjectAddCmd::ObjectType)type);

	if(ui->comboBoxObjectType->currentIndex()==(int)CQGlobe_ObjectAddCmd::Building)
