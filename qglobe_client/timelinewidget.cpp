...
void CameraTimeLineWidget::onGoto()
{
	...
	cameraInfo.m_loc.m_dLongitude=ckf.getLongitude()*qglobe_DEGTORAD;
	cameraInfo.m_loc.m_dLatitude=ckf.getLatitude()*qglobe_DEGTORAD;
	
	cameraInfo.m_orgDist=ckf.getAltitude();
	cameraInfo.m_roll=ckf.getHeading()*qglobe_DEGTORAD;
	cameraInfo.m_pitch=ckf.getTilt()*qglobe_DEGTORAD;
