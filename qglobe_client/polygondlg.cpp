...
void PolygonDlg::showEvent(QShowEvent *event)
{
	...
	m_pCommand = (CQGlobe_DrawPolygonCmd*)pCmdMgr->CreateCmd(eQGlobe_CMD_DRAW_POLYGON, this);
	...
	else
	{
		...
		pNode = (CGIS_Polygon*)qglobe_GetGISDoc()->GetNodeFromKey(m_placeMarkData.key);
...
{
	QString resStr = qglobe_GetWorkPath() + TEXTURE_SUBPATH;
