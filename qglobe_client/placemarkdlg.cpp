...
void PlaceMarkDlg::showEvent(QShowEvent *event)
{
	...
	m_pCommand = (CQGlobe_PointCmd*)pCmdMgr->CreateCmd(eQGlobe_CMD_PLACEMARK, this);
	...
	else
	{
		...
		pNode = (CGIS_PlaceIcon*)qglobe_GetGISDoc()->GetNodeFromKey(m_placeMarkData.key);
...
void PlaceMarkDlg::btnGo_click()
{
	...
	cameraInfo.m_loc.m_dLongitude =  m_placeMarkData.longitude * qglobe_DEGTORAD;
	cameraInfo.m_loc.m_dLatitude = m_placeMarkData.latitude * qglobe_DEGTORAD;
