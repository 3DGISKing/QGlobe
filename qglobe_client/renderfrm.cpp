...
#include "proxy.h"
#include "../qglobe_scene/QGlobe_SceneManager.h"//2013 2 1 mapscenenode
#include "../qglobe_scene/MapSceneNode.h"    //2013 2 1 mapscenenode
#define URL_MARK	"/"
