...
void qglobe_Get_CameraInfo(ST_REQUEST_SEARCH_IDLIST *data)
{
	CQGlobe_DataMgr *pMgr = qglobe_GetDataMgr();
	if(data == NULL)
		return;
...
int CQGlobe_SearchNode::Compare(const CQGlobe_SearchNode &a_cOther) const
{
	int ret = 0;
...
CQGlobe_SearchNode::CQGlobe_SearchNode(void)
{
	itemkey = 0;
	idCnt = 0;
