...
#include "Layer.h"
#include "../qglobe_scene/GIS_TextureIDCache.h"
...
void LayersDlg::UpdateDialog()
{
	...
	qglobe_GetDataMgr()->SetModifyFlag();
}
...
bool LayersDlg::AddTerrainItem()
{
	...
	TerrainLayer* layer=new TerrainLayer(E_QGlobe_SUBDATA_TYPE_DEM,("ASTER GDEM 1"));
...
bool LayersDlg::AddRenderItem()
{
	...
	ImageLayer* layer=new ImageLayer(E_QGlobe_SUBDATA_TYPE_IMG,tr("Google Image 2007"));
	...
	layer=new ImageLayer(E_QGlobe_SUBDATA_TYPE_IMG2011,tr("Google Image 2011"));
	layer->SetDataPath("geotexture/google2011");

	item=new LayerTreeItem(layer);
	m_ImageItem->appendRow(item);

	layer=new ImageLayer(E_QGlobe_SUBDATA_TYPE_IMG_NASA,tr("NASA"));
...
bool LayersDlg::AddAdminCenters()
{
	...
	PlaceNameLayer* layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_COUNTRY,tr("Country"));
	layer->SetProperty("tb_country");
	LayerTreeItem *item=new LayerTreeItem(layer);
	admincenter->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_POPULAR,tr("Capital"));
	layer->SetProperty("tb_popular");
	item=new LayerTreeItem(layer);
	admincenter->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_FIRSTADMIN,tr("First Level Admin Name"));
	layer->SetProperty("tb_firstadmin");
	item=new LayerTreeItem(layer);
	admincenter->appendRow(item);
	
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_SECONDADMIN,tr("Second Level Admin Name"));
	layer->SetProperty("tb_secondadmin");
	item=new LayerTreeItem(layer);
	admincenter->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_THIRDADMIN,tr("Third Level Admin Name"));
...
bool LayersDlg::AddSocialPlaceNames()
{
	...
	PlaceNameLayer* layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_FACTORY,tr("Factory"));

	LayerTreeItem *item=new LayerTreeItem(layer);
	admincenter->appendRow(item);

	iconName = g_app->GetResource("/sidebar/layers-popular-name.png");
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_MINE,tr("Mine"));

	item=new LayerTreeItem(layer);
	admincenter->appendRow(item);

	iconName = g_app->GetResource("/sidebar/layers-popular-name.png");
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_FARM,tr("Farm"));

	item=new LayerTreeItem(layer);
	admincenter->appendRow(item);

	iconName = g_app->GetResource("/sidebar/layers-1st-name.png");
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_SCHOOL,tr("School"));

	item=new LayerTreeItem(layer);
	admincenter->appendRow(item);

	iconName = g_app->GetResource("/sidebar/layers-2nd-name.png");
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_HOSPIATL,tr("Hospital"));

	item=new LayerTreeItem(layer);
	admincenter->appendRow(item);

	iconName = g_app->GetResource("/scene/city.png");
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_STATION,tr("Station"));

	item=new LayerTreeItem(layer);
	admincenter->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_AIRFIELD,tr("AirField"));
	...
	iconName = g_app->GetResource("/scene/city.png");
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_SERVICE,tr("Service"));
...
bool LayersDlg::AddPlaceNames()
{
	...
	PlaceNameLayer* layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_MOUNTAIN,tr("Mountain,Ridge"),iconName);
	layer->SetProperty("tb_mountain");

	LayerTreeItem *item=new LayerTreeItem(layer);
	placenames->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_SEA,tr("Sea"));
	...
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_RIVER,tr("River"),iconName);
	layer->SetProperty("tb_river");

	item=new LayerTreeItem(layer);
	placenames->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_ISLAND,tr("Island"));
	layer->SetProperty("tb_Island");

	item=new LayerTreeItem(layer);
	placenames->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_AIRPORT,tr("Airport"));
...
bool LayersDlg::AddSeaPlaceNames()
{
	...
	PlaceNameLayer* layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_HARBOUR,tr("Harbour"));
	layer->SetProperty("obj_harbour");
	LayerTreeItem *item=new LayerTreeItem(layer);
	placenames->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_DOCK,tr("Dock"));
	layer->SetProperty("obj_dock");
	item=new LayerTreeItem(layer);
	placenames->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_FIREWAY,tr("Fireway"));
	layer->SetProperty("obj_fireway");
	item=new LayerTreeItem(layer);
	placenames->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_TIDELAND,tr("TideLand"));
	layer->SetProperty("obj_tideland");
	item=new LayerTreeItem(layer);
	placenames->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_FISHFARM,tr("FishFarm"));
	layer->SetProperty("obj_fishfarm");

	item=new LayerTreeItem(layer);
	placenames->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_SEAFARM,tr("SeaFarm"));
	layer->SetProperty("obj_seafarm");
	item=new LayerTreeItem(layer);
	placenames->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_FISHERY,tr("Fishery"));
	...
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_MARINEFACOTRY,tr("MarineFactory"));
	layer->SetProperty("obj_marinefactory");
	item=new LayerTreeItem(layer);
	factoryitem->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_SEAWATERFACTORY,tr("SeaWaterFactory"));
	layer->SetProperty("obj_seawaterfactory");
	item=new LayerTreeItem(layer);
	factoryitem->appendRow(item);
	
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_IRRIGATIONFACTORY,tr("IrrigationFactory"));
	...
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_BEAUTY,tr("Beauty"));
	layer->SetProperty("obj_beauty");
	item=new LayerTreeItem(layer);
	protectionitem->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_SEABATHY,tr("SeaBathy Place"));
	layer->SetProperty("obj_seabathy");
	item=new LayerTreeItem(layer);
	protectionitem->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_SPA,tr("Spa"));
	...
	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_MISC_PROTECTION_POINT,tr("Misc Point Protection Object"));
	layer->SetProperty("obj_miscprotectionpoint");
	item=new LayerTreeItem(layer);
	miscprotectionitem->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_MISC_PROTECTION_POLYGON,tr("Misc Polygon Protection Object"));
	layer->SetProperty("obj_miscprotectionpolygon");
	item=new LayerTreeItem(layer);
	miscprotectionitem->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_ACCIDENT,tr("Accident"));
	layer->SetProperty("obj_accident");
	item=new LayerTreeItem(layer);
	placenames->appendRow(item);

	layer=new PlaceNameLayer(E_QGlobe_SUBDATA_TYPE_NAME_POLUTANT,tr("Polutant"));
...
bool LayersDlg::AddAdminBoundary()
{
	...
	PolylineLayer* layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_COUNTRY,tr("Country Border"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_FIRSTADMIN,tr("1st Level Admin Borders"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_SECONDADMIN,tr("2nd Level Admin Borders"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_THIRDADMIN,tr("3nd Level Admin Borders"));
...
bool LayersDlg::AddTransportNetwork()
{
	...
	PolylineLayer* layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_HIGHWAY,tr("HighWay"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_1STLOAD,tr("1st Road"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_2STLOAD,tr("2st Road"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_3STLOAD,tr("3st Road"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_4STLOAD,tr("4st Road"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_5STLOAD,tr("5st Road"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_WIDERAILWAY,tr("Wide Railway"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_NARROWRAILWAY,tr("Narrow Railway"));
...
bool LayersDlg::AddWaterNetwork()
{
	...
	PolylineLayer* layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_WIDERIVER,tr("Wide River"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_RIVER,tr("River"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_LAKE,tr("Lake, Reservoir"));
...
bool LayersDlg::AddLanduseBoundary()
{
	...
	PolylineLayer* layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_FARMLAND,tr("FarmLand"));
	layer->SetLevel(SHAPE_FARMLAND_MIN_LEVEL,SHAPE_FARMLAND_MAX_LEVEL);
	LayerTreeItem* item=new LayerTreeItem(layer);

	landboundarys->appendRow(item);

	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_NONFARMLAND,tr("NonFarmland"));
	...
	layer=new PolylineLayer(E_QGlobe_SUBDATA_TYPE_SHAPE_FORESTLAND,tr("Forest Land"));
...
bool LayersDlg::Add3dObject()
{
	...
	ObjectLayer* layer=new ObjectLayer(E_QGlobe_SUBDATA_TYPE_3D_BUILDING,tr("3D Model"));
	layer->SetDataPath("geoobject/3dmodel/geomesh");
	LayerTreeItem* item=new LayerTreeItem(layer);

	objects->appendRow(item);

	layer=new ObjectLayer(E_QGlobe_SUBDATA_TYPE_BUILDING_SIMPLEBUILDING,tr("2D FootPrint"));
...
void LayersDlg::timerEvent(QTimerEvent *event)
{
	...
	int level=qglobe_GetDataMgr()->m_pPyramidMgr->GetMaxLevel();
...
void LayersDlg::SetEnabledState(LayerTreeItem* item,int level)
{
	...
	else
	{
		...
		if(layer->GetMainType()==E_QGlobe_MAINDATA_TYPE_IMG)
			return;

		if(layer->GetMainType()==E_QGlobe_MAINDATA_TYPE_DEM)
			return;
...
bool LayersDlg::AddRasterItems()
{
	...
	RasterLayer* layer=new RasterLayer(E_QGlobe_SUBDATA_TYPE_RASTER_SUNENERGY,("SunEnergy"));
