...
#include "../qglobe_client/guiuty.h"
#include "../qglobe_client/mainwindow.h"
...
{
	QString iconPath = qglobe_GetWorkPath() + ICON_SUBPATH;
...
{
	QString texturePath = qglobe_GetWorkPath() + TEXTURE_SUBPATH;
