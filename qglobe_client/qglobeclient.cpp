...
#ifdef Q_WS_MAC
#define APP_TRANS_FNAME		"/qglobeclient_mac.qm"
#else
...
#define TIME            4000
	...
	cameraInfo.m_loc.m_dLongitude=LONGI_CHINA*qglobe_DEGTORAD;
	cameraInfo.m_loc.m_dLatitude=LATI_CHINA*qglobe_DEGTORAD;
