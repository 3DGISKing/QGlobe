...
#ifndef __GEO_ALLOCATOR_H_INCLUDED__
#define __GEO_ALLOCATOR_H_INCLUDED__
...
template<typename T>
class QGLOBE_TERRAINENGINE_EXPORT geoAllocator
{
public:

	//! Destructor
	virtual ~geoAllocator() {}
...
template<typename T>
class QGLOBE_TERRAINENGINE_EXPORT geoAllocatorFast
{
public:
