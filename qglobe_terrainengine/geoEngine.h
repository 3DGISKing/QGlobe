/* geoEngine.h -- interface of the 'Geo Engine'
  ...
  Please note that the Geo Engine is based in part on the work of the
  Independent JPEG Group, the zlib and the libPng. This means that if you use
  the Geo Engine in your product, you must acknowledge somewhere in your
  documentation that you've used the IJG code. It would also be nice to mention
  that you use the Geo Engine, the zlib and libPng. See the README files
  in the jpeglib, the zlib and libPng for further informations.
*/

#ifndef __GEOENGINE_H_INCLUDED__
#define __GEOENGINE_H_INCLUDED__
...
/*! \mainpage Geo Engine 1.5 API documentation
 *
 * <div align="center"><img src="logobig.png" ></div>
 *
 * \section intro Introduction
 *
 * Welcome to the Geo Engine API documentation.
 * Here you'll find any information you'll need to develop applications with
 * the Geo Engine. If you are looking for a tutorial on how to start, you'll
 * find some on the homepage of the Geo Engine at
 * <A HREF="http://irrlicht.sourceforge.net" >irrlicht.sourceforge.net</A>
 * or inside the SDK in the examples directory.
 *
 * The Geo Engine is intended to be an easy-to-use 3d engine, so
 ...
 * {
 *	// start up the engine
 *	GeoDevice *device = createDevice(video::EDT_DIRECT3D8,
 ...
 * \endcode
 *
 * Geo can load a lot of file formats automaticly, see geo::scene::ISceneManager::getMesh()
...
//! Everything in the Geo Engine can be found in this namespace.
namespace geo
{
	//! Creates an Geo device. The Geo device is the root object for using the engine.
	/** If you need more parameters to be passed to the creation of the Geo Engine device,
	...
	\return Returns pointer to the created GeoDevice or null if the
	device could not be created.
	*/
	GEOENGINE_API QGLOBE_TERRAINENGINE_EXPORT  GeoDevice* GEOCALLCONV createDevice(
	...
	//! Creates an Geo device with the option to specify advanced parameters.
	/** Usually you should used createDevice() for creating an Geo Engine device.
	...
	See geo::SGeoCreationParameters for details.
	\return Returns pointer to the created GeoDevice or null if the
	device could not be created. */
	GEOENGINE_API QGLOBE_TERRAINENGINE_EXPORT GeoDevice* GEOCALLCONV createDeviceEx(
