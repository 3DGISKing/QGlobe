#include "QGlobeDSConfigMgr.h"
#include "QGlobeDSDefine.h"
#include "QGlobeDSType.h"
#include "QGlobeDSCommon.h"
#include <QSettings>
#include <qglobal.h>
...
QGlobeDSConfig g_ServerConfig;

QGlobeDSConfig::QGlobeDSConfig()
{
...
bool QGlobeDSConfig::InitializeConfig(const QString& a_strCurPath)
{
...
void QGlobeDSConfig::ReadServerConfig()
{
	// server config
...
void QGlobeDSConfig::WriteServerConfig()
{
	// server config
#ifdef STANDARD_ALONE
	QSettings settings(QSettings::UserScope, CONF_SET_ORG, CONF_SET_APP);
