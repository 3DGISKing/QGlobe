...
class QGlobeDSServiceTrayIcon : public QSystemTrayIcon {
Q_OBJECT
public:
#if USE_DIALOG
	QGlobeDSServiceTrayIcon(QApplication *qapp, CtrlDialog *qdlg);
#else
	QGlobeDSServiceTrayIcon(QApplication *qapp);
#endif
	~QGlobeDSServiceTrayIcon(void);
