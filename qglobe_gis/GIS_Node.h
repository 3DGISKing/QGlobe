...
class QGLOBE_GIS_EXPORT CGIS_Node
{
public:
	CGIS_Node(void);
...
public:
	...
	QGlobe_PEN*		Get_Pen() {return &m_sPen;}
	QGlobe_BRUSH*		Get_Brush() {return &m_sBrush;}
