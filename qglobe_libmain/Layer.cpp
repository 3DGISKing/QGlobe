...
�˰�˼ ��˧ ���ݶ��� �Ҹ��˳�.
500k�˺���� shape������ ��˾ �� ���� �ư��� ������˳�.
̡��˼ QGlobeDSFileManager::ReadFileMap�� �س�.
�� �ܺ�̩ �ĵ����� a_pBuff��� memcpy�� ̡�� ���Ͱᰣ�� �����׶����� ������ ��� �ֳ�.*/
...
PlaceNameLayer::PlaceNameLayer(E_QGlobe_SUBDATA_TYPE subtype,QString name,QString iconfilename)
:Layer(E_QGlobe_MAINDATA_TYPE_NAME,subtype,name,iconfilename)
{
	_fontID=FSI_NORMAL;
	_iconSizeX=20;
	_iconSizeY=20;
...
RasterLayer::RasterLayer(E_QGlobe_SUBDATA_TYPE subtype,QString name,QString iconfilename)
  :Layer(E_QGlobe_MAINDATA_TYPE_RASTER,subtype,name,iconfilename)
{
	_nodatavalue=-9999;
