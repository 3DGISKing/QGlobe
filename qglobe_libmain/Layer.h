...
{
public:
	Layer(E_QGlobe_MAINDATA_TYPE maintype,E_QGlobe_SUBDATA_TYPE subtype,QString name, QString iconfilename="")
	{
		_mainType=maintype;
		_subType=subtype;
		_name=name;
	...
	inline E_QGlobe_MAINDATA_TYPE  GetMainType()     {return _mainType;}
	inline E_QGlobe_SUBDATA_TYPE   GetSubType()      {return _subType;}
	...
	inline bool                 IsTerrainLayer() {return _mainType==E_QGlobe_MAINDATA_TYPE_DEM;}
	inline bool                 IsImageLayer() {return _mainType==E_QGlobe_MAINDATA_TYPE_IMG;}
	inline bool                 IsPlaceNameLayer() {return _mainType==E_QGlobe_MAINDATA_TYPE_NAME;}
	inline bool                 IsRasterLayer() {return _mainType==E_QGlobe_MAINDATA_TYPE_RASTER;}

protected:
	QString             _name;
    QString             _iconfilename;  //absolute path
  
	E_QGlobe_MAINDATA_TYPE _mainType;
	E_QGlobe_SUBDATA_TYPE  _subType;
	QString             _dataPath;
...
{
public:
	TerrainLayer(E_QGlobe_SUBDATA_TYPE subtype,QString name,QString iconfilename="")
		:Layer(E_QGlobe_MAINDATA_TYPE_DEM,subtype,name,iconfilename)
	{
...
{
public:
	ImageLayer(E_QGlobe_SUBDATA_TYPE subtype,QString name,QString iconfilename="")
		:Layer(E_QGlobe_MAINDATA_TYPE_IMG,subtype,name,iconfilename)
	{
...
{
public:
	PlaceNameLayer(E_QGlobe_SUBDATA_TYPE subtype,QString name,QString iconfilename="");
...
{
public:
	PolylineLayer(E_QGlobe_SUBDATA_TYPE subtype,QString name,QString iconfilename="")
		:Layer(E_QGlobe_MAINDATA_TYPE_SHAPE,subtype,name,iconfilename)
	{
	}
...
{
public:
	ObjectLayer(E_QGlobe_SUBDATA_TYPE subtype,QString name,QString iconfilename="")
		:Layer(E_QGlobe_MAINDATA_TYPE_3D,subtype,name,iconfilename)
	{
