...
#define MONITOR_SERVICE_PATH    "/qglobeds_service_monitoring.exe"
#else
#define SERVICE_PATH    "/qglobeds_service"
#define MONITOR_SERVICE_PATH    "/qglobeds_service_monitoring"
#endif
...
{
	QGlobeDSServiceController controller(name);
...
{
	QGlobeDSServiceController gdsMonitorServiceController(MONITOR_SERVICE_NAME);
	...
	if (gdsMonitorServiceController.isInstalled())
	{
		QGlobeDSServiceController gdsServiceController(MAIN_SERVICE_NAME);
