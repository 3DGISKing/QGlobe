...
/** You should replace CQGlobe_Location3D with whatever your own Vector   **/
...
/** use of it in your own code.  Simply replace CQGlobe_Location3D with   **/
...
typedef CQGlobe_Location3D Vector3d;


bool InCircle(CQGlobe_Location3D &p, CQGlobe_Location3D &p1, CQGlobe_Location3D &p2, CQGlobe_Location3D &p3);
...
bool IsCCW(CQGlobe_Location3D &A,CQGlobe_Location3D &B,CQGlobe_Location3D &C);
...
struct Triangle{
	...
	bool isDelauney(CQGlobe_LocationArr &Vertexs)
	{
...
//typedef qglobe_array<Triangle>	TriangleArray;
