...
QGlobeDSUnixServerSocket::QGlobeDSUnixServerSocket(const QString &path, QObject *parent)
    : QTcpServer(parent)
{
    setPath(path);
}

QGlobeDSUnixServerSocket::QGlobeDSUnixServerSocket(QObject *parent)
    : QTcpServer(parent)
{
}

void QGlobeDSUnixServerSocket::setPath(const QString &path)
{
    path_.clear();
...
void QGlobeDSUnixServerSocket::close()
{
    QTcpServer::close();
    if (!path_.isEmpty()) {
