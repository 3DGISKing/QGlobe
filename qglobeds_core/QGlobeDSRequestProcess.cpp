...
//====================================================================================
// Function name	: QGlobeDSRequestDataForSA (for standard alone)
// Creator			: kangcj
...
//====================================================================================
bool QGlobeDSRequestDataForSA(IN void *in_buff, OUT void *out_buff, IN unsigned int out_buff_size)
{
	if (in_buff == NULL)
	{
		QGlobeDSLogOutput(E_LOG_ERROR, "Input buffer param is null at QGlobeDSRequestDataForSA.");
		return false;
	}

	if (out_buff == NULL || out_buff_size == 0)
	{
		QGlobeDSLogOutput(E_LOG_ERROR, "Output buffer param is null at QGlobeDSRequestDataForSA.");
		return false;
	}
	...
	QGlobeDSLogOutput(E_LOG_ERROR, "Response failed at QGlobeDSRequestDataForSA.[error : %s]", g_strErrorList[tErrorCode]);
	return false;
}
...
//====================================================================================
// Function name	: QGlobeDSReceivedRequestCallback
// Creator			: kangcj
// Description		: process request of client
// Return type		: bool - result(true : success, false : fail) 
...
bool QGlobeDSReceivedRequestCallback(INOUT unsigned char* a_pBuff)
{
	...
	{
#ifdef DEBUG
		QGlobeDSLogOutput(E_LOG_ERROR, "Buffer param is null at QGlobeDSReceivedRequestCallback.");
#endif
		return false;
	}
	...
	if (tErrorCode != E_RESPONSE_ERROR_INVALID_LEVEL)
		QGlobeDSLogOutput(E_LOG_ERROR, "GeoData response failed at QGlobeDSReceivedRequestCallback.[error : %s]", g_strErrorList[tErrorCode]);
	return false;
}
