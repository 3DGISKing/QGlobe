...
#include "../qglobe_scene/SampleMeshSceneNode.h"
...
class CQGlobe_ObjectAddCmd :public CQGlobe_Command
{
	Q_DECLARE_TR_FUNCTIONS(CQGlobe_ObjectAddCmd)
	...
	public:		  
		CQGlobe_ObjectAddCmd(CQGlobe_CommandDlg *pCmdDlg = NULL);
		~CQGlobe_ObjectAddCmd(void);
