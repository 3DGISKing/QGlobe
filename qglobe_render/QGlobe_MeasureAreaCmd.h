#ifndef QGlobe_MEASURE_AREA_CMD_H

#define QGlobe_MEASURE_AREA_CMD_H
...
class CQGlobe_MeasureAreaCmd :	public CQGlobe_Command
{
public:
	CQGlobe_MeasureAreaCmd(CQGlobe_CommandDlg *pCmdDlg = NULL);
	~CQGlobe_MeasureAreaCmd(void);
