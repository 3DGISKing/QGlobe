...
CQGlobe_Command::CQGlobe_Command(CQGlobe_CommandDlg *pCmdDlg)
{
	m_eCmdType = eQGlobe_CMD_NONE;
...
CQGlobe_Command::~CQGlobe_Command(void)
{
}

bool CQGlobe_Command::OnMouseWheelEvent(CursorState* mouseEvent)
{
...
void CQGlobe_Command::OnKeyPressEvent(KeyState keyState)
{
...
void CQGlobe_Command::OnEnd()
{
	m_pCommandMgr->CancelEditCmd();
}

void CQGlobe_Command::OnCancel()
{
	m_pCommandMgr->CancelEditCmd();
}

CQGlobe_Location3D	CQGlobe_Command::GetLocation(CursorState* mouseEvent)
{
	MOUSE_POSITION pos;
...
MOUSE_POSITION	CQGlobe_Command::GetCurrentLocation()
{
	return m_pCommandMgr->GetCursorPt();
}

void CQGlobe_Command::UpdateDailog(void)
{
	if(m_pCommandDlg)
