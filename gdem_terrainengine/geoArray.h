...
#ifndef __GEO_ARRAY_H_INCLUDED__
#define __GEO_ARRAY_H_INCLUDED__

#include "geoTypes.h"
#include "heapsort.h"
#include "geoAllocator.h"
...
*/
template <class T, typename TAlloc = geoAllocator<T> >
class array
{
...
public:
	...
	{
		_GEO_DEBUG_BREAK_IF(index>used) // access violation
	...
	T& getLast()
	{
		_GEO_DEBUG_BREAK_IF(!used) // access violation
	...
	{
		_GEO_DEBUG_BREAK_IF(index>=used || count<1 || index+count>used) // access violation
