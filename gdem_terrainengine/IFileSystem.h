...
public:
	...
	*/
	...
	/** After calling this, the Geo Engine will search and open files directly from this archive too.
	...
	/** Use createXMLReaderUTF8() if you prefer char* instead of wchar_t*. See IGeoXMLReader for
	...
	/** Use createXMLReader() if you prefer wchar_t* instead of char*. See IGeoXMLReader for
	more information on how to use the parser.
	\return 0, if file could not be opened, otherwise a pointer to the created
	IXMLReader is returned. After use, the reader
