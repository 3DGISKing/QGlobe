...
#ifdef _DEBUG
#define GEO_DEBUGPRINT(x) printf((x));
#else // _DEBUG 
#define GEO_DEBUGPRINT(x)
#endif // _DEBUG
...
//! implementation of the GeoXMLReader
template<class char_type, class superclass>
class CXMLReaderImpl : public IGeoXMLReader<char_type, superclass>
{
public:
