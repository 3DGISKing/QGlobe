...
#ifdef _GEO_COMPILE_WITH_LIBJPEG_
extern "C" {
	#ifndef _GEO_USE_NON_SYSTEM_JPEG_LIB_
...
#endif // _GEO_COMPILE_WITH_LIBJPEG_
...
public:
	...
	virtual IImage* loadImage(void* buffer, s32 size) const;
...
private:
	...
	*/
	...
	/* output error messages via Geo logger. */
