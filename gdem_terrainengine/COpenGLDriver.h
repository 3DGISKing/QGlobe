...
namespace video
{
	...
	public:
				...
				COpenGLDriver(const SGeoCreationParameters& params,
					io::IFileSystem* io, CGeoDeviceQT *device);
                #endif
                #if defined(_GEO_WINDOWS_API_) || defined(_GEO_USE_LINUX_DEVICE_) || defined(_GEO_USE_SDL_DEVICE_)
		COpenGLDriver(const SGeoCreationParameters& params, io::IFileSystem* io);
		#endif
		...
		bool initDriver(SGeoCreationParameters params);
		#endif
	...
	private:
		...
		virtual video::ITexture* createDeviceRGBTexture(IImage* surface, const char* name);
		...
		#ifdef _GEO_USE_QT_DEVICE_
			CGeoDeviceQT *_device;
		#elif defined (_GEO_WINDOWS_API_)
			HDC HDc; // Private GDI Device Context
			HWND Window;
			HGLRC HRc; // Permanent Rendering Context
        #endif
        #if defined(_GEO_USE_LINUX_DEVICE_)
            GLXDrawable g_Drawable;
		//kimyi : Use QT
		//#elif defined(_GEO_USE_OSX_DEVICE_)
		//	CGeoDeviceMacOSX *_device;
		#endif
	};
