...
namespace scene
{
	...
	enum E_ANIMATED_MESH_TYPE
	{
		...
		//! Pulsar LMTools .lmts file. This Geo loader was written by Jonas Petersen
		EAMT_LMTS,
	...
	You might want to use geo::scene::SAnimatedMesh, geo::scene::SMesh,
	geo::scene::SMeshBuffer etc. */
