...
//! constructor
CGeoDeviceSDL::CGeoDeviceSDL(const SGeoCreationParameters& param)
...
bool CGeoDeviceSDL::createWindow()
{
	if ( Close )
		return false;
...
//! create the driver
void CGeoDeviceSDL::createDriver()
{
		...
		case SDL_MOUSEBUTTONUP:
			...
			case  1:
				irrevent.MouseInput.Event =
					(SDL_event.type == SDL_MOUSEBUTTONDOWN) ? geo::EMIE_LMOUSE_PRESSED_DOWN : geo::EMIE_LMOUSE_LEFT_UP;
				break;

			case  2:
				irrevent.MouseInput.Event =
					(SDL_event.type == SDL_MOUSEBUTTONDOWN) ? geo::EMIE_RMOUSE_PRESSED_DOWN : geo::EMIE_RMOUSE_LEFT_UP;
				break;

			case  3:
				irrevent.MouseInput.Event =
					(SDL_event.type == SDL_MOUSEBUTTONDOWN) ? geo::EMIE_MMOUSE_PRESSED_DOWN : geo::EMIE_MMOUSE_LEFT_UP;
				break;
			}

			if (irrevent.MouseInput.Event != geo::EMIE_MOUSE_MOVED)
				postEventFromUser(irrevent);
			break;
...
bool CGeoDeviceSDL::activateJoysticks(core::array<SJoystickInfo> & joystickInfo)
{
#if defined(_GEO_COMPILE_WITH_JOYSTICK_EVENTS_)
	joystickInfo.clear();
...
void CGeoDeviceSDL::sleep(u32 timeMs, bool pauseTimer)
{
...
void CGeoDeviceSDL::setWindowCaption(const wchar_t* text)
{
...
bool CGeoDeviceSDL::present(video::IImage* surface, void* windowId, core::rect<s32>* srcClip)
{
...
void CGeoDeviceSDL::closeDevice()
{
	Close = true;
}
...
video::IVideoModeList* CGeoDeviceSDL::getVideoModeList()
{
...
void CGeoDeviceSDL::setResizeAble(bool resize)
{
...
bool CGeoDeviceSDL::isWindowActive() const
{
...
bool CGeoDeviceSDL::isWindowFocused() const
{
...
bool CGeoDeviceSDL::isWindowMinimized() const
{
...
video::ECOLOR_FORMAT CGeoDeviceSDL::getColorFormat() const
{
	if (Screen)
	{
		...
		return CGeoDeviceStub::getColorFormat();
}


void CGeoDeviceSDL::createKeyMap()
{
...
{
	CGeoDeviceSDL* dev = new CGeoDeviceSDL(param);
