...
public:
	...
	//! constructor
	COpenGLTexture(IImage* surface, const char* name, COpenGLDriver* driver=0, ECOLOR_FORMAT format= ECF_A8R8G8B8);
	...
	virtual bool validateTexture();

	virtual const IImage* getImage() const { return Image; }
