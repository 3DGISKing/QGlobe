...
namespace scene
{
	//! Name of the parameter for changing how Geo handles the ZWrite flag for transparent (blending) materials
	/** The default behavior in Geo is to disable writing to the
	...
	**/ 
	...
	const c8* const GEO_SCENE_MANAGER_IS_EDITOR = "GEO_Editor";
