...
namespace video
{
	...
	/** In Geo, alpha refers to opacity. 
	...
	Alpha in Geo is opacity, so 0 is fully transparent, 255 is fully opaque (solid).
	This class is used by most parts of the Geo Engine
