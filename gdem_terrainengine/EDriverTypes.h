...
namespace video
{
	...
	//! An enum for all types of drivers the Geo Engine supports.
	enum E_DRIVER_TYPE
	{
		...
		//! The Geo Engine Software renderer, runs on all
		...
		//! renderer for Geo. Basically it can be described as the
		//! Geo Software renderer on steroids. It rasterizes 3D
