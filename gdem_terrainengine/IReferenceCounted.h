...
namespace geo
{
	...
	//! Base class of most objects of the Geo Engine.
	/** This class provides reference counting through the methods grab() and drop().
	It also is able to store a debug string for every instance of an object.
	Most objects of the Geo
	Engine are derived from IReferenceCounted, and so they are reference counted.

	When you create an object in the Geo engine, calling a method
	...
	*/
	...
	public:
		...
		the Geo Engine are derived from IReferenceCounted, and so
		they are reference counted.

		When you create an object in the Geo engine, calling a
		...
		objects of the Geo Engine are derived from
		...
		bool drop() const
		{
			...
			_GEO_DEBUG_BREAK_IF(ReferenceCounter <= 0)
