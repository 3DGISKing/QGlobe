...
//! overlay texture map  material renderer
class COpenGLMaterialRenderer_OVERLAY_ALPHA_TEXTURE : public COpenGLMaterialRenderer
{
public:

	COpenGLMaterialRenderer_OVERLAY_ALPHA_TEXTURE(video::COpenGLDriver* d)
		: COpenGLMaterialRenderer(d) {}
		...
		bool resetAllRenderstates, IMaterialRendererServices* services)
	{
		...
		if (material.MaterialType != lastMaterial.MaterialType || resetAllRenderstates)
		{
			...
			if (Driver->queryFeature(EVDF_MULTITEXTURE))
			{
				...
				glTexEnvi(GL_TEXTURE_ENV, GL_SOURCE0_ALPHA_ARB, GL_PREVIOUS_EXT);
				glTexEnvi(GL_TEXTURE_ENV, GL_OPERAND0_ALPHA_ARB, GL_SRC_ALPHA);
				glTexEnvi(GL_TEXTURE_ENV, GL_SOURCE1_ALPHA_ARB, GL_TEXTURE);
				glTexEnvi(GL_TEXTURE_ENV, GL_OPERAND1_ALPHA_ARB, GL_SRC_ALPHA);
				//glTexEnvi(GL_TEXTURE_ENV, GL_SOURCE2_ALPHA_ARB, GL_PREVIOUS_EXT);
