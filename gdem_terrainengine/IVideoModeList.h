...
#ifndef __GEO_I_VIDEO_MODE_LIST_H_INCLUDED__
#define __GEO_I_VIDEO_MODE_LIST_H_INCLUDED__
...
namespace video
{
	...
	/** You can get a list via GeoDevice::getVideoModeList(). If you are confused
	now, because you think you have to create an Geo Device with a video
	mode before being able to get the video mode list, let me tell you that
	there is no need to start up an Geo Device with EDT_DIRECT3D8, EDT_OPENGL or
