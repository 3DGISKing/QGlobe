...
namespace geo
{
	...
	*/
	GEOENGINE_API GDEM_TERRAINENGINE_EXPORT  GeoDevice* GEOCALLCONV createDevice(
	...
	\return Returns pointer to the created GeoDevice or null if the
	device could not be created. */
	GEOENGINE_API GDEM_TERRAINENGINE_EXPORT GeoDevice* GEOCALLCONV createDeviceEx(
