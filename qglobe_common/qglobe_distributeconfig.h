#ifndef __QGLOBE_DISTRIBUTECONFIG_H__
#define __QGLOBE_DISTRIBUTECONFIG_H__
...
public:
	...
	unsigned int GetTargetIndex(E_QGlobe_MAINDATA_TYPE a_eDataType, unsigned int a_nLevel, unsigned int a_nX, unsigned int a_nY);
	bool GetPCInfo(E_QGlobe_MAINDATA_TYPE a_eDataType, unsigned int a_nLevel, unsigned int a_nX, unsigned int a_nY, ST_DISTRIBUTE_PC& a_PCInfo);
	bool GetFolderInfo(E_QGlobe_MAINDATA_TYPE a_eDataType, unsigned int a_nLevel, unsigned int a_nX, unsigned int a_nY, ST_DISTRIBUTE_FOLDER& a_Path);
