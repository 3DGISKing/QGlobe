#ifndef _QGLOBE_PROTOCOL_H_
#define _QGLOBE_PROTOCOL_H_
...
typedef enum {
	E_QGlobe_MAINDATA_TYPE_IMG		= 0,			/* terrain imagery data*/
	E_QGlobe_MAINDATA_TYPE_DEM		= 1,			/* terrain elevation height data*/
	E_QGlobe_MAINDATA_TYPE_SHAPE	= 2,			/* terrain elevation height data*/
	E_QGlobe_MAINDATA_TYPE_NAME	= 3,			/* terrain elevation height data*/
	E_QGlobe_MAINDATA_TYPE_3D		= 4,			/* 3D building, texture data */
	E_QGlobe_MAINDATA_TYPE_RASTER  =5,
	E_QGlobe_MAINDATA_TYPE_MAX,						/* max count type*/
	E_QGlobe_MAINDATA_TYPE_NONE
} E_QGlobe_MAINDATA_TYPE;


// geometric subject data type
typedef enum {
	E_QGlobe_SUBDATA_TYPE_NONE					    = 0,

	//����
	E_QGlobe_SUBDATA_TYPE_IMG					    = 1,
	E_QGlobe_SUBDATA_TYPE_IMG_NASA				    = 2,
	E_QGlobe_SUBDATA_TYPE_IMG2011                  = 60 ,

	//���˷���
	E_QGlobe_SUBDATA_TYPE_DEM					    = 3,

	//3��̺����
	E_QGlobe_SUBDATA_TYPE_3D_BUILDING			    = 4,
	E_QGlobe_SUBDATA_TYPE_BUILDING_SIMPLEBUILDING	= 5,

	//�Լ��ڻ���
	E_QGlobe_SUBDATA_TYPE_NAME_COUNTRY			    = 6,
	E_QGlobe_SUBDATA_TYPE_NAME_POPULAR			    = 7,
	E_QGlobe_SUBDATA_TYPE_NAME_FIRSTADMIN		    = 8,
	E_QGlobe_SUBDATA_TYPE_NAME_SECONDADMIN		    = 9,
	E_QGlobe_SUBDATA_TYPE_NAME_THIRDADMIN		    = 10,

    //�����ݺ�
	E_QGlobe_SUBDATA_TYPE_NAME_BROMZEITEM			= 11,	
	E_QGlobe_SUBDATA_TYPE_NAME_HISTORICSITEITEM	= 12,
	E_QGlobe_SUBDATA_TYPE_NAME_BATTLESITEITEM		= 13,
	E_QGlobe_SUBDATA_TYPE_NAME_MONUMENTITEM		= 14,
	E_QGlobe_SUBDATA_TYPE_NAME_MUSEUMITEM			= 15,	
	E_QGlobe_SUBDATA_TYPE_NAME_POSITIONITEM		= 16,
	E_QGlobe_SUBDATA_TYPE_NAME_GUIDANCEITEM		= 17,

	//�跷
	E_QGlobe_SUBDATA_TYPE_NAME_MOUNTAIN	        = 18,
	E_QGlobe_SUBDATA_TYPE_NAME_SEA		            = 19,
	E_QGlobe_SUBDATA_TYPE_NAME_ISLAND			    = 20,
	E_QGlobe_SUBDATA_TYPE_NAME_RIVER			    = 21,
	E_QGlobe_SUBDATA_TYPE_NAME_AIRPORT			    = 22,
	
	E_QGlobe_SUBDATA_TYPE_SHAPE_COUNTRY		    = 23,		//�����ұ�
	E_QGlobe_SUBDATA_TYPE_SHAPE_FIRSTADMIN		    = 24,		//���ұ�
	E_QGlobe_SUBDATA_TYPE_SHAPE_SECONDADMIN	    = 25,		//��ұ�
	E_QGlobe_SUBDATA_TYPE_SHAPE_THIRDADMIN		    = 26,		//���ұ�

	E_QGlobe_SUBDATA_TYPE_SHAPE_HIGHWAY		    = 27,		
	E_QGlobe_SUBDATA_TYPE_SHAPE_1STLOAD		    = 28,		
	E_QGlobe_SUBDATA_TYPE_SHAPE_2STLOAD    	    = 29,
	E_QGlobe_SUBDATA_TYPE_SHAPE_3STLOAD		    = 30,
	E_QGlobe_SUBDATA_TYPE_SHAPE_4STLOAD    	    = 31,
	E_QGlobe_SUBDATA_TYPE_SHAPE_5STLOAD		    = 32,

	E_QGlobe_SUBDATA_TYPE_SHAPE_WIDERAILWAY   	    = 33,
	E_QGlobe_SUBDATA_TYPE_SHAPE_NARROWRAILWAY	    = 34,

	E_QGlobe_SUBDATA_TYPE_SHAPE_WIDERIVER   	    = 35,
	E_QGlobe_SUBDATA_TYPE_SHAPE_RIVER       	    = 36,
	E_QGlobe_SUBDATA_TYPE_SHAPE_LAKE        	    = 37,

	E_QGlobe_SUBDATA_TYPE_SHAPE_FARMLAND   	    = 38,
	E_QGlobe_SUBDATA_TYPE_SHAPE_NONFARMLAND   	    = 39,
	E_QGlobe_SUBDATA_TYPE_SHAPE_FORESTLAND   	    = 40,
	
	//���ȴݺ�
	E_QGlobe_SUBDATA_TYPE_NAME_HARBOUR             = 41,//�߰�
	E_QGlobe_SUBDATA_TYPE_NAME_DOCK                = 42,//����
	E_QGlobe_SUBDATA_TYPE_NAME_FIREWAY             = 43,//�ߵ�
	E_QGlobe_SUBDATA_TYPE_NAME_TIDELAND            = 44,//������
	E_QGlobe_SUBDATA_TYPE_NAME_FISHFARM            = 45,//���̻�
	E_QGlobe_SUBDATA_TYPE_NAME_SEAFARM             = 46,//�Ȼ���
	E_QGlobe_SUBDATA_TYPE_NAME_FISHERY             = 47,//�̻�
	E_QGlobe_SUBDATA_TYPE_NAME_MARINEFACOTRY       = 48,//�㺤���պ�
	E_QGlobe_SUBDATA_TYPE_NAME_SEAWATERFACTORY     = 49,//�Ƴ޷϶�˦���պ�
	E_QGlobe_SUBDATA_TYPE_NAME_IRRIGATIONFACTORY   = 50,//�㱶��˦���պ�
	E_QGlobe_SUBDATA_TYPE_NAME_BEAUTY              = 51,//������
	E_QGlobe_SUBDATA_TYPE_NAME_SEABATHY            = 52,//�ͺ�����
	E_QGlobe_SUBDATA_TYPE_NAME_SPA                 = 53,//���
	E_QGlobe_SUBDATA_TYPE_NAME_MISC_PROTECTION_POINT    = 54,//���������ݺ�(��)
	E_QGlobe_SUBDATA_TYPE_NAME_MISC_PROTECTION_POLYGON  = 55,//���������ݺ�(��)
	E_QGlobe_SUBDATA_TYPE_NAME_ACCIDENT            = 56,//����̡��
	E_QGlobe_SUBDATA_TYPE_NAME_POLUTANT            = 57,//�������
	
	E_QGlobe_SUBDATA_TYPE_RASTER_SUNENERGY          = 58,//�������
	E_QGlobe_SUBDATA_TYPE_RASTER_SUNENERGY1         = 59,//�������

	
	E_QGlobe_SUBDATA_TYPE_MAX                      = 61

} E_QGlobe_SUBDATA_TYPE;
/************************************/
...
{
	E_QGlobe_SUBDATA_TYPE		sub_type;
	int						id;	
} ST_RECORD_ID;
...
typedef struct _tagREQUEST_GEODATA
{
	...
	unsigned int		row;					// y
	E_QGlobe_MAINDATA_TYPE		main_type;
	E_QGlobe_SUBDATA_TYPE		sub_type;
} ST_REQUEST_GEODATA;
/***********************************************************************************/
...
{
	int					id;
	E_QGlobe_SUBDATA_TYPE	type;					// E_QGlobe_SUBDATA_TYPE
	float				longitude;
	float				latitude;
	float				height;
	float				view_height;
