#ifndef __QGlobe_FLIGHT_SIM_TYPES_H__
#define __QGlobe_FLIGHT_SIM_TYPES_H__
...
typedef	CQGlobe_Vector3DF	FS_Vector3;
...
typedef CQGlobe_Matrix4	FS_Tensor;

typedef	QGlobe_Coord3D		FS_Coord;

// defines
#define FS_DEG2RAD			qglobe_DEGTORAD
#define FS_RAD2DEG			qglobe_RADTODEG
...
const	FS_Radian		FS_RAD_90				= 90 * qglobe_DEGTORAD;
