...
CQGlobe_AircraftSpecs::CQGlobe_AircraftSpecs( void )
{
...
void 
CQGlobe_AircraftSpecs::ChooseAircraftType( FS_Aircraft_Type a_aircraftType )
{
...
void CQGlobe_AircraftSpecs::SetAircraftSpecs_P51()
{
	// Mass:
	m_Mass					= 4175.0f;					
...
void CQGlobe_AircraftSpecs::SetAircraftSpecs_A4()
{
	// Mass:
	m_Mass					= 7000.0f;
...
void CQGlobe_AircraftSpecs::SetAircraftSpecs_MIRAGE2000()
{
	// Mass:
	m_Mass					= 13800.0f;					
