...
bool	
CQGlobe_FlightSim::OnMousePress(CursorState* mouseEvent)
{
	if ( m_Paused || m_Ended )
		return true;
...
bool	
CQGlobe_FlightSim::OnMouseMove(CursorState* mouseEvent)
{
...
void 
CQGlobe_FlightSim::HandleKeyEvent( int a_key, 
...
void	
CQGlobe_FlightSim::OnKeyPressEvent(KeyState keyState)
{
	if ( m_Ended )
		return ;
