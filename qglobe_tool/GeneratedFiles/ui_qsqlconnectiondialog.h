...
public:
    ...
    void setupUi(QDialog *QSqlConnectionDialogUi)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/SQLiteManager/Resources/Hopeclient.ico"), QSize(), QIcon::Normal, QIcon::Off);
        QSqlConnectionDialogUi->setWindowIcon(icon);
        ...
        gridLayout->addWidget(comboDriver, 0, 1, 1, 2);
        ...
        gridLayout->addWidget(portSpinBox, 5, 1, 1, 2);
        ...
        dlgButton = new QPushButton(connGroupBox);
        dlgButton->setObjectName(QString::fromUtf8("dlgButton"));
        dlgButton->setEnabled(true);
        dlgButton->setMaximumSize(QSize(25, 22));

        gridLayout->addWidget(dlgButton, 1, 2, 1, 1);
    ...
    void retranslateUi(QDialog *QSqlConnectionDialogUi)
    {
        ...
        editDatabase->setText(QCoreApplication::translate("QSqlConnectionDialogUi", "D:/dbworld.db3", nullptr));
        ...
        dlgButton->setText(QCoreApplication::translate("QSqlConnectionDialogUi", "...", nullptr));
