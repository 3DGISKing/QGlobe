...
public:
    ...
    void setupUi(QWidget *Browser)
    {
        ...
        sqlEdit = new QPlainTextEdit(groupBox);
        ...
        QWidget::setTabOrder(clearButton, connectionWidget);
    ...
    void retranslateUi(QWidget *Browser)
    {
        ...
        connectButton->setText(QCoreApplication::translate("Browser", "Connect...", nullptr));
    } // retranslateUi
